...
import {
  ...
  ArrowUpRight, Clock, CheckCircle2, TrendingUp, RefreshCw,
} from "lucide-react"
import {
...
import { streamFromTags } from "@/lib/stay"
...
type LiveStats = {
  ...
  residencyOccupied: number // occupied beds tagged "Residencies" — unified view across both streams
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <StatCard
          ...
          sub={loading ? "Loading…" : `${stats.occupied} of ${stats.totalBeds} beds · ${stats.coLivingOccupied} co-living / ${stats.residencyOccupied} residency`}
          icon={Building2}
          accent
        />
        <StatCard
